...
def _find_dicom_image_series(image_folder, allowed_modalities, modality=None, series_uid=None, frame_of_ref_uid=None,
    ...
    if len(file_list) == 0:
        raise FileNotFoundError(f"The image folder {image_folder} does not contain any DICOM files.")
    ...
    if len(file_list) == 0:
        print("series_modality", series_modality, "requested modality", requested_modality)
